@include('./Master/Partials/__head')
<body id="top">
    <header>
      @include('./Master/Partials/__header')
    </header>
    ...
    <div class="page-header page-header-small" filter-color="green">
      ...
      <div class="container">
        <div class="content-center">
          <div class="cc-profile-image"><a href="#"><img src="images/ONDOBO.jpg" alt="Image"/></a></div>
          <div class="h2 title">Rapha ONDOBO MVOLO</div>
          <p class="category text-white">Full Stack Developer, System and Administrator </p><a class="btn btn-primary smooth-scroll mr-2" href="#contact" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Contact Me</a><a class="btn btn-primary" href="#" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Download CV</a>
        </div>
      </div>
      <div class="section">
        <div class="container">
